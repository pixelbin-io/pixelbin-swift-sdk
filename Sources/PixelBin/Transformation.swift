...
public class Transformation {
     ...
     * @param guidancescale Guidance Scale (Default: 30)

     * @param numberofinferencesteps Number of inference steps (Default: 50)
    ...
    public static func bgExtend(
        ...
        guidancescale: Int? = 30,

        numberofinferencesteps: Int? = 50,
